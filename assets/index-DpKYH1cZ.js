 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const eE={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},tE=500,nE=600,rE="_blank",iE="http://localhost";class Kc{constructor(t){this.window=t,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function oE(e,t,n,r=tE,i=nE){const o=Math.max((window.screen.availHeight-i)/2,0).toString(),s=Math.max((window.screen.availWidth-r)/2,0).toString();let a="";const l=Object.assign(Object.assign({},eE),{width:r.toString(),height:i.toString(),top:o,left:s}),u=ue().toLowerCase();n&&(a=rp(u)?rE:n),np(u)&&(t=t||iE,l.scrollbars="yes");const d=Object.entries(l).reduce((m,[g,w])=>`${m}${g}=${w},`,"");if(Cw(u)&&a!=="_self")return sE(t||"",a),new Kc(null);const f=window.open(t||"",a,d);x(f,e,"popup-blocked");try{f.focus()}catch{}return new Kc(f)}function sE(e,t){const n=document.createElement("a");n.href=e,n.target=t;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gE=5*60,vE=Fh("authIdTokenMaxAge")||gE;let Yc=null;const yE=e=>async t=>{const n=t&&await t.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>vE)return;const i=n==null?void 0:n.token;Yc!==i&&(Yc=i,await fetch(e,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function wE(e=Kh()){const t=Xn(e,"auth");if(t.isInitialized())return t.getImmediate();const n=$w(e,{popupRedirectResolver:fE,persistence:[I_,d_,_p]}),r=Fh("authTokenSyncURL");if(r){const o=yE(r);o_(n,o,()=>o(n.currentUser)),i_(n,s=>o(s))}const i=Uy("auth");return i&&Vw(n,`http://${i}`),n}function _E(){var e,t;return(t=(e=document.getElementsByTagName("head"))===null||e===void 0?void 0:e[0])!==null&&t!==void 0?t:document}Dw({loadJS(e){return new Promise((t,n)=>{const r=document.createElement("script");r.setAttribute("src",e),r.onload=t,r.onerror=i=>{const o=Qe("internal-error");o.customData=i,n(o)},r.type="text/javascript",r.charset="UTF-8",_E().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});mE("Browser");var EE="firebase",SE="10.8.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */qe(EE,SE,"app");const Pp="@firebase/installations",eu="0.6.5";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rp=1e4,Np=`w:${eu}`,xp="FIS_v2",IE="https://firebaseinstallations.googleapis.com/v1",kE=60*60*1e3,TE="installations",CE="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function OE({appConfig:e,heartbeatServiceProvider:t},{fid:n}){const r=Ap(e),i=Mp(e),o=t.getImmediate({optional:!0});if(o){const u=await o.getHeartbeatsHeader();u&&i.append("x-firebase-client",u)}const s={fid:n,authVersion:xp,appId:e.appId,sdkVersion:Np},a={method:"POST",headers:i,body:JSON.stringify(s)},l=await Up(()=>fetch(r,a));if(l.ok){const u=await l.json();return{fid:u.fid||n,registrationStatus:2,refreshToken:u.refreshToken,authToken:Lp(u.authToken)}}else throw await Dp("Create Installation",l)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const LE=/^[cdef][\w-]{21}$/,Va="";function DE(){try{const e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16;const n=ME(e);return LE.test(n)?n:Va}catch{return Va}}function ME(e){return AE(e).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nu(e){let t;const n=await Jo(e.appConfig,r=>{const i=$E(r),o=BE(e,i);return t=o.registrationPromise,o.installationEntry});return n.fid===Va?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function $E(e){const t=e||{fid:DE(),registrationStatus:0};return Bp(t)}function BE(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const i=Promise.reject(dn.create("app-offline"));return{installationEntry:t,registrationPromise:i}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},r=VE(e,n);return{installationEntry:n,registrationPromise:r}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:HE(e)}:{installationEntry:t}}async function VE(e,t){try{const n=await OE(e,t);return Co(e.appConfig,n)}catch(n){throw Op(n)&&n.customData.serverCode===409?await $p(e.appConfig):await Co(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function HE(e){let t=await Jc(e.appConfig);for(;t.registrationStatus===1;)await jp(100),t=await Jc(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:r}=await nu(e);return r||n}return t}function Jc(e){return Jo(e,t=>{if(!t)throw dn.create("installation-not-found");return Bp(t)})}function Bp(e){return WE(e)?{fid:e.fid,registrationStatus:0}:e}function WE(e){return e.registrationStatus===1&&e.registrationTime+Rp<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ru(e,t=!1){let n;const r=await Jo(e.appConfig,o=>{if(!Vp(o))throw dn.create("not-registered");const s=o.authToken;if(!t&&YE(s))return o;if(s.requestStatus===1)return n=qE(e,t),o;{if(!navigator.onLine)throw dn.create("app-offline");const a=XE(o);return n=QE(e,a),a}});return n?await n:r.authToken}async function qE(e,t){let n=await Xc(e.appConfig);for(;n.authToken.requestStatus===1;)await jp(100),n=await Xc(e.appConfig);const r=n.authToken;return r.requestStatus===0?ru(e,t):r}function Xc(e){return Jo(e,t=>{if(!Vp(t))throw dn.create("not-registered");const n=t.authToken;return ZE(n)?Object.assign(Object.assign({},t),{authToken:{requestStatus:0}}):t})}async function QE(e,t){try{const n=await KE(e,t),r=Object.assign(Object.assign({},t),{authToken:n});return await Co(e.appConfig,r),n}catch(n){if(Op(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await $p(e.appConfig);else{const r=Object.assign(Object.assign({},t),{authToken:{requestStatus:0}});await Co(e.appConfig,r)}throw n}}function Vp(e){return e!==void 0&&e.registrationStatus===2}function YE(e){return e.requestStatus===2&&!JE(e)}function JE(e){const t=Date.now();return t<e.creationTime||e.creationTime+e.expiresIn<t+kE}function XE(e){const t={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},e),{authToken:t})}function ZE(e){return e.requestStatus===1&&e.requestTime+Rp<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e1(e){const t=e,{installationEntry:n,registrationPromise:r}=await nu(t);return r?r.catch(console.error):ru(t).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function t1(e,t=!1){const n=e;return await n1(n),(await ru(n,t)).token}async function n1(e){const{registrationPromise:t}=await nu(e);t&&await t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Po="analytics",l1="firebase_id",u1="origin",c1=60*1e3,d1="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",iu="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
